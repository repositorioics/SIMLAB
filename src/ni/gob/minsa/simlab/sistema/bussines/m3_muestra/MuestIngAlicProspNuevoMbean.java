...
@ManagedBean(name="muestIngAlicProspNuevoMbean")
@ViewScoped

public class MuestIngAlicProspNuevoMbean extends GenericMbean implements Serializable{
	...
	public MuestIngAlicProspNuevoMbean(){
		super();
...
public void suggestLocationMA2017() throws SimlabAppException{
	...
	public boolean validateFieldsToAdd() throws SimlabAppException{	
		...
		if(this.getStudy().matches("Muestreo Anual")||this.getStudy().matches("Muestreo Anual 2017")||this.getStudy().matches("Muestreo Anual 2018")) this.tipo="muestreoanual";
...
//			this.removeObjectRegAlicFromList();
	...
	public void regAlic(Session session, String codeAlic, Integer posBox, Integer codBox, Integer codFreezer, 
		...
		try {
			...
			throw SimlabAppException.generateExceptionByInsert(MuestIngAlicProspNuevoMbean.class, exception);
		}
}
