	...
	public void actionSuggestLocation(ActionEvent event){
		try {
			...
			if (this.getStudy().matches("Muestreo Anual 2017") && this.getTypeAlicFromCodeAlic().matches("14[t|T|p|P]{1}")){
				...
				else if(this.getTypeAlicFromCodeAlic().matches("AD17[t1|T1]{2}")) {
					this.sugerirUbicacion();
				}

				else if(this.getTypeAlicFromCodeAlic().matches("AD17[t2|T2]{2}")) {
					this.sugerirUbicacion();
				}
				...
				Object[] ubicacion = simlabAlicuotaService.getUbicacionMCV20(this.getCodeAlic());
				if (ubicacion!=null) {
					this.setCodeRack(ubicacion[3].toString());
					this.setCodeBox(Integer.parseInt(ubicacion[4].toString()));
					this.setCodeBoxInUse(Integer.parseInt(ubicacion[4].toString()));
				...
				else if(this.getTypeAlicFromCodeAlic().matches("CV17[t|T]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("CV17[t1|T1]{2}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("CV17[t2|T2]{2}")) {
					this.sugerirUbicacion();
				}
				...
				Object[] ubicacion = simlabAlicuotaService.getUbicacionMA2021(this.getCodeAlic());
				if (ubicacion!=null) {
					this.setCodeRack(ubicacion[3].toString());
					this.setCodeBox(Integer.parseInt(ubicacion[4].toString()));
					this.setCodeBoxInUse(Integer.parseInt(ubicacion[4].toString()));
				...
				else if(this.getTypeAlicFromCodeAlic().matches("18[n|N]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("18[h|H]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("18[i|I]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("18[b|B]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("18[e|E]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("18[t|T]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("18[s|S]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("18[z|Z]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("18[px|PX]{2}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("18[px1|PX1]{3}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("18[px2|PX2]{3}")) {
					this.sugerirUbicacion();
				}

				else if(this.getTypeAlicFromCodeAlic().matches("18[u|U]{1}")) {
					this.sugerirUbicacion();
				}

				else if(this.getTypeAlicFromCodeAlic().matches("18[c|C]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("18[d|D]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("18[v|V]{1}")) {
					this.sugerirUbicacion();
				}
				...
				Object[] ubicacion = simlabAlicuotaService.getUbicacionEstMinsa(this.getCodeAlic());
				if (ubicacion!=null) {
					this.setCodeRack(ubicacion[3].toString());
					this.setCodeBox(Integer.parseInt(ubicacion[4].toString()));
					this.setCodeBoxInUse(Integer.parseInt(ubicacion[4].toString()));
					...
					Object[] ubicacion = simlabAlicuotaService.getUbicacionMA2022(this.getCodeAlic());
					if (ubicacion!=null) {
						this.setCodeRack(ubicacion[3].toString());
						this.setCodeBox(Integer.parseInt(ubicacion[4].toString()));
						this.setCodeBoxInUse(Integer.parseInt(ubicacion[4].toString()));
					...
					else if(this.getTypeAlicFromCodeAlic().matches("19[n|N]{1}")) {
						this.sugerirUbicacion();
					}
					else if(this.getTypeAlicFromCodeAlic().matches("19[h|H]{1}")) {
						this.sugerirUbicacion();
					}
					else if(this.getTypeAlicFromCodeAlic().matches("19[i|I]{1}")) {
						this.sugerirUbicacion();
					}
					else if(this.getTypeAlicFromCodeAlic().matches("19[b|B]{1}")) {
						this.sugerirUbicacion();
					}
					else if(this.getTypeAlicFromCodeAlic().matches("19[e|E]{1}")) {
						this.sugerirUbicacion();
					}
					else if(this.getTypeAlicFromCodeAlic().matches("19[t|T]{1}")) {
						this.sugerirUbicacion();
					}
					else if(this.getTypeAlicFromCodeAlic().matches("19[s|S]{1}")) {
						this.sugerirUbicacion();
					}
					else if(this.getTypeAlicFromCodeAlic().matches("19[z|Z]{1}")) {
						this.sugerirUbicacion();
					}
					else if(this.getTypeAlicFromCodeAlic().matches("19[px|PX]{2}")) {
						this.sugerirUbicacion();
					}
					else if(this.getTypeAlicFromCodeAlic().matches("19[px1|PX1]{3}")) {
						this.sugerirUbicacion();
					}
					else if(this.getTypeAlicFromCodeAlic().matches("19[px2|PX2]{3}")) {
						this.sugerirUbicacion();
					}

					else if(this.getTypeAlicFromCodeAlic().matches("19[u|U]{1}")) {
						this.sugerirUbicacion();
					}

					else if(this.getTypeAlicFromCodeAlic().matches("19[c|C]{1}")) {
						this.sugerirUbicacion();
					}
					else if(this.getTypeAlicFromCodeAlic().matches("19[d|D]{1}")) {
						this.sugerirUbicacion();
					}
					else if(this.getTypeAlicFromCodeAlic().matches("19[v|V]{1}")) {
						this.sugerirUbicacion();
					}
					else if (this.getEstudioParticipante()!=null) {
						this.sugerirUbicacionMA2018(this.getEstudioParticipante());
				...
				Object[] ubicacion = simlabAlicuotaService.getUbicacionMA2023(this.getCodeAlic());
				if (ubicacion!=null) {
					this.setCodeRack(ubicacion[3].toString());
					this.setCodeBox(Integer.parseInt(ubicacion[4].toString()));
					this.setCodeBoxInUse(Integer.parseInt(ubicacion[4].toString()));
				...
				else if(this.getTypeAlicFromCodeAlic().matches("20[n|N]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("20[h|H]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("20[i|I]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("20[b|B]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("20[e|E]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("20[t|T]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("20[s|S]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("20[z|Z]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("20[px|PX]{2}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("20[px1|PX1]{3}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("20[px2|PX2]{3}")) {
					this.sugerirUbicacion();
				}

				else if(this.getTypeAlicFromCodeAlic().matches("20[u|U]{1}")) {
					this.sugerirUbicacion();
				}

				else if(this.getTypeAlicFromCodeAlic().matches("20[c|C]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("20[d|D]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("20[v|V]{1}")) {
					this.sugerirUbicacion();
				}
				else if (this.getEstudioParticipante()!=null) {
					this.sugerirUbicacionMA2018(this.getEstudioParticipante());
				...
				Object[] ubicacion = simlabAlicuotaService.getUbicacionMA2024(this.getCodeAlic());
				if (ubicacion!=null) {
					this.setCodeRack(ubicacion[3].toString());
					this.setCodeBox(Integer.parseInt(ubicacion[4].toString()));
					this.setCodeBoxInUse(Integer.parseInt(ubicacion[4].toString()));
				...
				else if(this.getTypeAlicFromCodeAlic().matches("21[n|N]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("21[h|H]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("21[i|I]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("21[b|B]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("21[e|E]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("21[t|T]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("21[s|S]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("21[z|Z]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("21[px|PX]{2}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("21[px1|PX1]{3}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("21[px2|PX2]{3}")) {
					this.sugerirUbicacion();
				}

				else if(this.getTypeAlicFromCodeAlic().matches("21[u|U]{1}")) {
					this.sugerirUbicacion();
				}

				else if(this.getTypeAlicFromCodeAlic().matches("21[c|C]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("21[d|D]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("21[v|V]{1}")) {
					this.sugerirUbicacion();
				}
				else if (this.getEstudioParticipante()!=null) {
					this.sugerirUbicacionMA2018(this.getEstudioParticipante());
				...
				Object[] ubicacion = simlabAlicuotaService.getUbicacionMA2CARES2024(this.getCodeAlic());
				if (ubicacion!=null) {
					this.setCodeRack(ubicacion[3].toString());
					this.setCodeBox(Integer.parseInt(ubicacion[4].toString()));
					this.setCodeBoxInUse(Integer.parseInt(ubicacion[4].toString()));
				...
				else if(this.getTypeAlicFromCodeAlic().matches("R24[A]{1}")) {
					this.sugerirUbicacion();
				}
				else if(this.getTypeAlicFromCodeAlic().matches("R24[B]{1}")) {
					this.sugerirUbicacion();
				}

				else if(this.getTypeAlicFromCodeAlic().matches("R24[T1|T2]{2}")) {
					this.sugerirUbicacion();
				}
				else if (this.getEstudioParticipante()!=null) {
					this.sugerirUbicacionMA2018(this.getEstudioParticipante());
...
public void suggestLocationMA2017() throws SimlabAppException{
	...
	public void actionValidateTypePosOrNot() throws SimlabAppException{
		...
		try {
			if (this.getStudy().matches("Estudio Hospitalario")) {
				...
				patternAlicIsRight = SimlabPatternService.isRightPattern(this.getCodeAlic(), SimlabParameterService.getParameterCode(CatalogParam.LIST_PATRON, 46));
			} else if (this.getStudy().matches("Muestreo Anual 2022")) {
				...
				patternAlicIsRight = SimlabPatternService.isRightPattern(this.getCodeAlic(), SimlabParameterService.getParameterCode(CatalogParam.LIST_PATRON, 50));
			}else if (this.getStudy().matches("Muestreo A2CARES 2024")) {
				patternAlicIsRight = SimlabPatternService.isRightPattern(this.getCodeAlic(), SimlabParameterService.getParameterCode(CatalogParam.LIST_PATRON, 51));
			}
	...
	public void validateCodeAlicuota() throws SimlabAppException{
		...
		else if (this.getStudy().matches("Estudio Hospitalario")){
		...
		//Validamos que el codigo de Alicuota Ingresado corresponda a algun tipo de alicuota registrado en la BD.
			...
			if(!SimlabPatternService.isRightPattern(this.getCodeAlic(), SimlabParameterService.getParameterCode(CatalogParam.LIST_PATRON, 46)))
				throw new SimlabAppException(10038);
			//Validamos que el codigo de Alicuota Ingresado corresponda a algun tipo de alicuota registrado en la BD.
		}
		else if (this.getStudy().matches("Muestreo Anual 2022")){
			if(!SimlabPatternService.isRightPattern(this.getCodeAlic(), SimlabParameterService.getParameterCode(CatalogParam.LIST_PATRON, 47)))
				throw new SimlabAppException(10038);
			//Validamos que el codigo de Alicuota Ingresado corresponda a algun tipo de alicuota registrado en la BD.
		}
			...
			if(!SimlabPatternService.isRightPattern(this.getCodeAlic(), SimlabParameterService.getParameterCode(CatalogParam.LIST_PATRON, 50)))
				throw new SimlabAppException(10038);
			//Validamos que el codigo de Alicuota Ingresado corresponda a algun tipo de alicuota registrado en la BD.
		}

		else if (this.getStudy().matches("Muestreo A2CARES 2024")){
			if(!SimlabPatternService.isRightPattern(this.getCodeAlic(), SimlabParameterService.getParameterCode(CatalogParam.LIST_PATRON, 51)))
				throw new SimlabAppException(10038);
			//Validamos que el codigo de Alicuota Ingresado corresponda a algun tipo de alicuota registrado en la BD.
		}
